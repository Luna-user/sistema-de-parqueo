...
@section('content_header')<h1>Editar Método de Pago</h1>@stop
@section('content')
<div class="row justify-content-center">
    <div class="col-md-5">
        <div class="card card-outline card-warning">
            <div class="card-header"><h3 class="card-title">Actualizar: <b>{{ $metodo->nombre }}</b></h3></div>
            <div class="card-body">
                <form action="{{ route('admin.metodo_pagos.update', $metodo->id_metodo) }}" method="POST">
                    @csrf @method('PUT')
