...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Vehículos (Tipos)',
            'url' => 'admin/tipo-vehiculos',
            'icon' => 'fas fa-fw fa-car',
            'classes' => 'bg-blue text-white',
            'active' => ['admin/tipo-vehiculo*'],
            'can' => 'ver tipo vehiculos',
        ],
        [
            'text' => 'Membresías',
        ...
        [
            ...
            'url' => 'admin/metodo-pagos',
            'icon' => 'fas fa-fw fa-wallet',
            'classes' => 'bg-blue text-white',
            'active' => ['admin/metodo-pago*'],
        ...
        ['header' => 'Ajustes del Sistema', 'can' => 'ver ajustes'],
        [
            'text' => 'Ajustes',
            'url' => 'admin/ajustes',
